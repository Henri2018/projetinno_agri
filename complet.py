...
def attributionParametres1(par):
    ...
    Hcc=par['Hcc']
    HpF=par['HpF']
    return(alpha,delta,beta,gamma,fsdc,Mr,Ma,mu,l,ebmax1,ebmax2,eimax,k,D,C,R,Vmax,Ncrit1,Ncrit2,Ncrit3,Nmax1,Nmax2,eb1,eb2,eb3,LAI1,LAI2,LAI3,RNG1,RNG2,NGmax,Tmin,Tmax,Toptimum,MSseuil,ebflo,SENESCeb,percNgrainflo,P1Gmax,RDTmax,HP1Gmax,P1G0,WSC,MSaa,aremob,Rem1,SENESC1,SENESC2,SENESC3,DC,Hmin,Hcc,HpF)
